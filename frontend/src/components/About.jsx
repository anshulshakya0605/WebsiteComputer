...
import FounderSMS from './FounderSMS';
function About() {
  return (
    <>
    <div className='flex flex-col md:flex-row items-center justify-between px-6 lg:px-20 pt-6'>
        <div className='w-full md:w-1/2 flex items-center justify-center'>
            <img src={fav} alt="fav" className='mb-5 md:mb-0' />
        </div>
        <div className='w-full md:w-1/2 flex items-center justify-center'>
            <div>
                <h1 className='text-orange-700 font-bold text-3xl mb-3'>About Us</h1>
                <h3 className='text-2xl font-semibold mb-3 uppercase'>Shree BalaJi Computer <span> <ReactTyped 
                className='text-orange-700'
                strings={['Institute', 'Center']}
                typeSpeed={70}
                backSpeed={80}
                loop={true}
                 /> </span> </h3>
